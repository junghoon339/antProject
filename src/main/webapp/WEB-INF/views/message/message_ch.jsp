         ...
         .ready(
               function() {
                  ...
                  $("#messageDeleteBtn")
                        .click(
                              function() {
                                 ...
                                 alert(messageNos);
                                 location.href = "${pageContext.request.contextPath}/message/messageDelete?messageNos="
                                       + messageNos
                                       + "&flag=${flag}";
                  ...
                  $(document)
                        .on(
                              ...
                              function() {
                                 ...
                                 location.href = "${pageContext.request.contextPath}/message/sendCancel?messageNo="
                                       + messageNo;
                  ...
                  $("#submitBt")
                        .click(
                              function() {
                                 location.href = "${pageContext.request.contextPath}/message/main?searchText="
                                       + $("#searchText").val()
                                       + "&userNo=${sessionScope.userDTO.userNo}&categoryNo="
                                       + $("#category").val()
                                       + "&flag=${flag}";
                              })
      ...
      $
            .ajax({
               ...
               data : "messageNo=" + messageNo + "&"
                     + $("#securityInfo").attr("name") + "="
                     + $("#securityInfo").val() + "&flag=${flag}",
               dataType : "json",
               success : function(re) {
                  //모달창을 메모읽는 창으로 바꿔줌
                     ...
                     <div class="table-responsive">
                        ...
                        <table id="mytable" class="table table-bordred table-striped">
                           ...
                           <thead>
                              ...
                              <th style="width:10px;"><input type="checkbox" id="checkall"
                                 value="-1"></th>
                              ...
                              <c:choose>
                                 ...
                                 <c:otherwise>
                                    ...
                                    <th style="width:100px;">받은날짜</th>
                                    <th style="width:100px;">발송취소</th>
                                 </c:otherwise>
                              </c:choose>
                                    ...
                                    <c:when test="${flag==false}">
                                       ...
                                       <c:if test="${messageDTO.messageState!=1 }">
                                          <tr>
                                             ...
                                             <td><input type="checkbox" class="checkthis"
                                                name="messageNoArr" value="${messageDTO.messageNo }">
                                             </td>

                                             <td>${messageDTO.userDTO.userId}
                                                (${messageDTO.userDTO.userName})</td>
                                             <td><div
                                                   style="white-space: nowrap; text-overflow: ellipsis; width: 400px; overflow: hidden;">
                                                   <a
                                                      href="javascript:messageSelect(${messageDTO.messageNo });">${messageDTO.messageContent}</a>
                                                </div></td>
                                                ...
                                                <c:when test="${messageDTO.messageReceiveTime==null }">
                                                   ...
                                                   <td><p data-placement="top" data-toggle="tooltip"
                                                         ...
                                                         <button class="btn btn-Info btn-filter"
                                                            ...
                                                            name="${messageDTO.messageNo}" style="padding:5px 9px;">
                                                            <div class="icon-container">
                        ...
                        <div style="text-align: center">
                           ...
                           <ul class="pagination">
                              <c:choose>
                                 ...
                                 <c:otherwise>
                                    <li class="disabled"><a
                                       href="${pageContext.request.contextPath}/message/main?userNo=${sessionScope.userDTO.userNo }&flag=${flag }&pageNumber=${endPage-pageSu}"><div
                                             class="icon-container">
                                             <span class="ti-angle-double-left"></span>
                                          </div></a></li>
                                 </c:otherwise>
                              ...
                              <c:forEach begin="${startPage}" end="${endPage}" var="pageNum"
                                 step="1">
                                 <li><a
                                    href="${pageContext.request.contextPath}/message/main?userNo=${sessionScope.userDTO.userNo }&flag=${flag}&pageNumber=${pageNum}&searchText=${searchText}&categoryNo=${categoryNo}">${pageNum}</a></li>
                              </c:forEach>
                              ...
                              <c:choose>
                                 ...
                                 <c:otherwise>
                                    <li><a
                                       href="${pageContext.request.contextPath}/message/main?userNo=${sessionScope.userDTO.userNo }&flag=${flag }&pageNumber=${startPage+pageSu}"><div
                                             class="icon-container">
                                             <span class="ti-angle-double-right"></span>
                                          </div></a></li>
                                 </c:otherwise>
                                 ...
                                 <form class="form-horizontal"
                                    ...
                                    <fieldset>
                                       ...
                                       <div class="form-group" id="messageTop">
                                          <label class="col-md-8 control-label" for="name"
                                             style="text-align: right; width: 100px"
                                             id="messageTopLabel">받을사람</label>
                                          <div class="col-md-8">
                                       ...
                                       <div class="form-group">
                                          <label class="col-md-8 control-label" for="anschrift"
                                             style="width: 100px">내용</label>
                                          <div class="col-md-8">
                                             <textarea class="form-control" id="messageContent"
                                                name="messageContent" rows="7" placeholder="내용을 입력하세요"></textarea>
                                          </div>
                                       </div>
