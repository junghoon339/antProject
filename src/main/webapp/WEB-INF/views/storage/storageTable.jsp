...
<head>
	...
	<script language="javascript">
  	function showPopup() { 
  		window.open(
  				"${pageContext.request.contextPath}/storage/insertForm/1", "insertForm", "width=650, height=500, left=380, top=80"
  				); 
  		}
  </script>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="/storage/table/1"><i class="icon-align-justify"></i><span class="hidden-tablet">자료실</span></a></li>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>자료실</h2>
						<div class="box-icon">
							<%-- <a href="${pageContext.request.contextPath}/storage/insertForm/1" style="color:white">글쓰기</a> --%>
							<a href="#" onclick="showPopup();" style="color:white">글쓰기</a>
					...
					<div class="box-content">
						...
						<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
							...
							<tr>
								...
								<td class="center">${item.storageTitle}</td>
								<td class="center">${item.userDTO.userName}</td>
								<td>${item.writeDay}</td>
								<c:choose>
								<c:when test="${item.fileName==null}">
								<td class="center">
									<span class="label label-warning">파일이 없습니다.</span>	
								</td>
								</c:when>
								<c:otherwise>
								<td class="center">
									<span class="label label-info">${item.fileName}</span>
								</td>
								</c:otherwise>
								</c:choose>
								  <td>${item.readNum}</td>
								  <td class="center">
									<a class="btn btn-success" href="${pageContext.request.contextPath}/storage/tableDetail/${item.storageNo}">
