									...
									<div class="col-lg-12">
										<form id="login-form"
											...
											<div class="form-group text-center">
												...
												<h2 style="color: #8aca86"><strong>환영합니다.</strong></h2> <br>
												<h5><strong style="color: #8aca86">${userDTO.userName}</strong>님, 회원가입을 축하합니다!</h5>
												<h5>아이디는 <strong style="color: #8aca86">${userDTO.userId}</strong> 입니다.</h5><br>
											</div>
											<div class="form-group">
												<div class="row">
													<div class="col-sm-6 col-sm-offset-3">
														<input type="submit" name="login-submit" id="login-submit"
															class="form-control btn btn-login" value="시작하기">
													</div>
												</div>
											</div>
											<div class="form-group">
