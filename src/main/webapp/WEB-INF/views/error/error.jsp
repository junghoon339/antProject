		...
		<div class="main-panel">
			...
			<div class="content">
				<div class="container-fluid">
					...
					<br>
					<br>
						<img style="display: block; margin: 0 auto;" src="${pageContext.request.contextPath}/resources/img/forbid.png">
						<br>
						<br>
						<h3 style="text-align: center;"><strong>서비스 이용에 불편을 드려 죄송합니다.
						잠시 후 다시 이용해 주시기 바랍니다.</strong></h3>
						
						<h5 style="text-align: center;"><strong>오류 메시지 : </strong>${msg}</h5>
					</div>
				</div>
			</div>
