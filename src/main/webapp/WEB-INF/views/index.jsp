...
<head>
	...
	<!-- start: Favicon -->
	<link rel="shortcut icon" href="${pageContext.request.contextPath}/resources/storage/img/favicon.ico">
	<!-- end: Favicon -->
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="${pageContext.request.contextPath}/storage/storageTable/1"><i class="icon-align-justify"></i><span class="hidden-tablet"> ÀÚ·á½Ç</span></a></li>
				...
				<div class="widget span3 red" onTablet="span6" onDesktop="span3">
					...
					<div class="content">
						...
						<div class="browserStat big">
							<img src="${pageContext.request.contextPath}/resources/storage/img/browser-chrome-big.png" alt="Chrome">
							<span>34%</span>
						</div>
						<div class="browserStat big">
							<img src="${pageContext.request.contextPath}/resources/storage/img/browser-firefox-big.png" alt="Firefox">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="${pageContext.request.contextPath}/resources/storage/img/browser-ie.png" alt="Internet Explorer">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="${pageContext.request.contextPath}/resources/storage/img/browser-safari.png" alt="Safari">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="${pageContext.request.contextPath}/resources/storage/img/browser-opera.png" alt="Opera">
							<span>34%</span>
						</div>	
				...
				<div class="box black span4" onTablet="span6" onDesktop="span4">
					...
					<div class="box-content">
						<ul class="dashboard-list metro">
							<li class="green">
								<a href="#">
									<img class="avatar" alt="Dennis Ji" src="${pageContext.request.contextPath}/resources/storage/img/avatar.jpg">
								</a>
