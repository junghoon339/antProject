            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/vote/CreateForm"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">dStatistics</span></a></li>
