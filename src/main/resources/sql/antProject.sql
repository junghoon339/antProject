...
CREATE TABLE project(
   ...
   project_state         NUMBER DEFAULT 0 --0:������, 1:��������������(CRUD�Ұ�), 2:������Ʈ����(CRUD�Ұ�)
);
...
CREATE TABLE project_user(
   ...
   project_user_task     varchar2(50) --���ó� ���� ���� ����   
);
...
insert into message values(seq_message_no.nextval,(select user_no from ant_user where user_id='13@naver.com'),'�����ߵǳ�',sysdate,null,0,13);
